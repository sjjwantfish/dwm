...
static const char *fonts[]               = { "Hack Regular Nerd Font Complete:style=medium:size=13", "monospace:size=13" };
...
static const Rule rules[] = {
    ...
    {NULL,                   "dev-sidecar",                 NULL,             1 << 9,       0,           0,        -1 },
...
static Key keys[] = {
    ...
    { MODKEY,              XK_Return,       zoom,             {0} },                     /* super enter        |  将当前聚焦窗口置为主窗口 */
